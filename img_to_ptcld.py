...
can be compared to other semantic depth datasets.
...
filename = f"sem_img_arr-stepIdx_{step_index}.pt"
sem_img_arr = None
if os.path.exists(filename):
    sem_img_arr = torch.load(filename)
...
torch.save(sem_img_arr, f"sem_img_arr-stepIdx_{step_index}.pt")
